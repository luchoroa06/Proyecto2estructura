 ...
 * @author sebas
 */
public class Coladeimpresionarbol extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Coladeimpresionarbol.class.getName());
static Arbol arbol; 
    static Tabla tabla;
    static ListaUsuario usuarios;
    /**
     * Creates new form coladeimpresionarbol
     */
    public Coladeimpresionarbol(Arbol a, Tabla t, ListaUsuario u) {
        initComponents();
        this.arbol= a;
        this.tabla= t;
        this.usuarios= u;
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 80, 160, 70));
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 290, 100, 50));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new Coladeimpresionarbol(arbol,tabla,usuarios).setVisible(true));
    }
